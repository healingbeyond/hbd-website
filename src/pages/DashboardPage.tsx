              ...
              {[
                {
                  ...
                  desc: "Review the available HBDI information and resources.",
                  color: "bg-chart-1",
                },
                {
                  title: "Explore assessments",
                  desc: "Access the available assessments and recovery tools.",
                  color: "bg-chart-2",
                },
                {
                  title: "Connect",
                  desc: "Use the contact page to reach Healing Beyond Diagnosis.",
                  color: "bg-chart-3",
                },
              ].map((step, i) => (
