    ...
    <footer className="bg-navy text-cream/80">
      <div className="container mx-auto py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
          <div className="space-y-4">
            ...
            <p className="text-cream/60 text-sm leading-relaxed max-w-xs">Support. Healing. Hope.</p>
            <p className="text-cream/50 text-sm">Ottawa Valley · Renfrew County · Ontario</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Link to="/steph-sara" className="text-cream/60 hover:text-teal transition-colors text-sm">STEPH / SARA</Link>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <a href="mailto:corey@healingbeyonddiagnosis.ca" className="text-teal hover:text-teal-light transition-colors text-sm">corey@healingbeyonddiagnosis.ca</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto py-6">
          ...
          <p className="text-cream/30 text-xs text-center mt-4">© {new Date().getFullYear()} Healing Beyond Diagnosis Initiative. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
